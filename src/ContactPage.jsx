...
const ContactPage = () => {
  ...
  // Contact Info Data
  const contactInfo = [
      { id: 1, label: "Email Support", value: "ExamCheckplus@support.com", icon: <Mail size={24} color="#ea580c"/> },
      { id: 2, label: "Phone Number", value: "+234 800 123 4567", icon: <Phone size={24} color="#059669"/> },
      { id: 3, label: "Facebook", value: "ExamCheckPlus Official", icon: <Facebook size={24} color="#1877F2"/> },
      { id: 4, label: "Instagram", value: "@ExamCheckPlus", icon: <Instagram size={24} color="#E4405F"/> },
      { id: 5, label: "Twitter (X)", value: "@ExamCheck_Plus", icon: <Twitter size={24} color="#1DA1F2"/> },
  ];
     ...
     {/* ======================= */} 
      ...
      <main className="desktop-main"> 
        ...
        <div className="profile-content-wrapper">
            <div className="profile-detail-card">
                ...
                <div className="large-avatar" style={{background: 'linear-gradient(to right, #0ea5e9, #2563eb)'}}>
                    <Phone size={50} />
                </div>
                
                <h2>Contact Us</h2>
                <p style={{color: '#64748b', marginBottom: '30px'}}>We are here to help you 24/7.</p>
      ...
      <div className="mobile-layout"> 
        ...
        <div className="profile-detail-card" style={{padding: '20px'}}>
            ...
            <h2 style={{fontSize: '1.5rem', marginBottom: '10px'}}>Get in Touch</h2>
