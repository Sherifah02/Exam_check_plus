          ...
          {viewState === "input" && (
            <div className="profile-detail-card" style={{ maxWidth: "450px" }}>
              ...
              <p style={{ marginBottom: "30px", color: "#64748b" }}>
                View your semester performance.
              </p>
          ...
          {viewState === "error" && (
            <div className="profile-detail-card" style={{ maxWidth: "450px" }}>
              ...
              <p style={{ color: "#64748b", marginBottom: "30px" }}>
                The results for this semester have not been uploaded by the
      ...
      <div className="mobile-layout">
        ...
        {viewState === "result" && (
          <div className="profile-detail-card" style={{ padding: "15px" }}>
            ...
            <button className="venue-button" onClick={handleDownload}>
              Download
            </button>
            <button
              className="venue-button-secondary"
