...
import {
  ...
  Search, Mail, Hash, BookOpen, Calendar, GraduationCap, X, Layers
} from 'lucide-react';
  ...
  return (
    ...
    <div className="dashboard-container admin-theme">
      ...
      <main className="desktop-main">
        ...
        <div className="profile-content-wrapper" style={{alignItems: 'flex-start', paddingTop: '40px'}}>

            <div className="profile-detail-card" style={{maxWidth: '600px'}}>

                {/* SEARCH SECTION */}
                <h2 style={{marginBottom: '20px', color: '#0f172a'}}>Student Verification</h2>
                ...
                <div style={{display: 'flex', gap: '10px', width: '100%', marginBottom: '30px'}}>
                    ...
                    />
                    <button className="venue-button" onClick={handleSearch} style={{marginTop: 0, width: 'auto', padding: '0 24px'}}>
                        <Search size={20} />
                    </button>
                </div>
                ...
                {studentData && (
                    <div style={{width: '100%', animation: 'fadeIn 0.3s ease'}}>
                        ...
                        <div style={{width: '100%', height: '1px', backgroundColor: '#e2e8f0', marginBottom: '30px'}}></div>

                        <h3 style={{color: '#059669', marginBottom: '20px', textDecoration: 'underline'}}>Student Information</h3>

                        {/* Avatar & Name */}
                        <div className="large-avatar" style={{margin: '0 auto 20px auto', background: '#0f172a'}}>
                            <User size={60} />
                        </div>
        ...
        <div className="profile-detail-card" style={{padding: '20px'}}>
             ...
             <div style={{display: 'flex', flexDirection: 'column', gap: '10px', width: '100%', marginBottom: '20px'}}>
                    <input
                        ...
                        onChange={(e) => setSearchId(e.target.value)}
                    />
                    <button className="venue-button" onClick={handleSearch} style={{marginTop: 0}}>
                        Search
                    </button>
            </div>
            ...
            {studentData && (
                <div style={{marginTop: '20px', width: '100%'}}>
                    <div className="large-avatar" style={{margin: '0 auto 15px auto', background: '#0f172a'}}>
                        <User size={50} />
                    </div>
                    <h2 style={{fontSize: '1.4rem', marginBottom: '20px'}}>{studentData.fullName}</h2>

                    <div className="profile-info-group">
                         <div className="info-row">
                            <span className="info-label">Faculty</span>
                            <div className="info-value" style={{fontSize: '0.9rem'}}>{studentData.faculty}</div>
                        </div>
                        <div className="info-row">
                            <span className="info-label">Department</span>
                        ...
                        <div className="info-row">
                         ...
                         <div className="info-row" style={{borderBottom:'none'}}>
                            ...
                            <div className="info-value" style={{fontSize: '0.9rem', wordBreak: 'break-all'}}>{studentData.email}</div>
                        </div>
                    </div>
                </div>
            )}
